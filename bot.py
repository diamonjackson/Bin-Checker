...
async def start(event):
    ...
    [Button.url("Mʏ Sᴏᴜʀᴄᴇ Cᴏᴅᴇ", "https://github.com/diamonjackson/Bin-Checker/")]
    ])
...
"""
    await event.reply(text, buttons=[[Button.url("Mʏ Sᴏᴜʀᴄᴇ Cᴏᴅᴇ", "https://github.com/diamonjackson/Bin-Checker/")]])
